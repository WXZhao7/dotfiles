...
function M.setup(vars)
    ...
    hl.bind(mainMod .. " + mouse_down", hl.dsp.focus({workspace = "e+1"}),
            {description = "Focus workspace e+1"})
    ...
    hl.bind("XF86AudioRaiseVolume", hl.dsp
                .exec_cmd("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 5%+"),
    ...
    hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("playerctl play-pause"),
            {locked = true}, {description = "Play/Pause audio"})
    ...
    hl.bind(mainMod .. " + ALT + DELETE", hl.dsp.exec_cmd("uwsm stop"),
            {description = "Exit Hyprland by UWSM"})
